...
";
  ...
  public function postProcess() {
    ...
    if (CRM_Utils_Array::value('send_receipt', $params)) {
      ...
      // JMA Changes
      if ($this->_id && !CRM_Utils_Array::value('registered_by_id',  $this->_defaultValues)) {
        $participantId = $this->_id;
        $contactId = $this->_contactId;
        $isTest = CRM_Utils_Array::value('is_test', $this->_defaultValues);
        $eventParams = array('id' => $this->_eventId);
        CRM_Event_BAO_Event::retrieve($eventParams, $this->_values['event']);
        ...
        $this->_values['params'][$this->_id] = $params;
        CRM_Event_BAO_Event::buildCustomDisplay($this->_values['custom_pre_id'],
          'customPre',
          $contactId,
          $template,
          $participantId,
        ...
        CRM_Event_BAO_Event::buildCustomDisplay($this->_values['custom_post_id'],
          'customPost',
          $contactId,
          $template,
          $participantId,
        ...
        if ($this->_values['event']['is_multiple_registrations']) {
          ...
          list($this->_values['additional_custom_pre_id'],
            $this->_values['additional_custom_post_id']) = CRM_Core_BAO_UFJoin::getUFGroupIds($ufJoinParams);
